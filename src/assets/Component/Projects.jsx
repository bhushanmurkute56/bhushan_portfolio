import projectImg from "./../Component/Projects.jpg"
  ...
  return (
    ...
    <div className='text-center text-3xl pt-1 pb-15'>
        ...
        <div className="flex justify-center mt-10 flex-col md:flex-row pl-15 md:pl-0">
            ...
            mb-10 md:mb-0">
                <img src={projectImg} alt="" className="h-[200px] w-[250px] border-1 rounded-2xl mx-auto m-5 border-black"/>
            ...
            <div className="h-[400px] w-[400px] border-1 rounded-2xl bg-[#f2f2f2] shadow-lg border-pink-400 mb-15 md:mb-0">
                <img src={projectImg} alt="" className="h-[200px] w-[250px] border-1 border-black rounded-2xl mx-auto m-5"/>
                <div className="text-sm">
